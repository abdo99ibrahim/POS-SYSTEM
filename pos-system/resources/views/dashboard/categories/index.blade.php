                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('dashboard.products.index',['category_id'=>$category->id]) }}" class="btn btn-success
                            btn-sm">@lang('site.related_products')</a></td>
                            <td>
                                ...
                                @else
                                <button type="submit" class="btn btn-danger btn-sm disabled"><i class="fa fa-trash"></i>
